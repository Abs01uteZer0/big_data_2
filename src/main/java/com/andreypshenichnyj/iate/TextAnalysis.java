...
public class TextAnalysis {
    ...
    public static void main(String[] args) throws IOException {
        // Настройка Spark
        SparkConf conf = new SparkConf().setAppName("TextAnalysis").setMaster("local[*]");
        ...
        top50MostCommon.forEach(System.out::println);

        System.out.println("Top 50 Least Common Words:");
        top50LeastCommon.forEach(System.out::println);
        ...
        System.out.println("Кол-во слов в тексте: " + countAfterStemming);
        ...
        top50MostCommonStemmed.forEach(System.out::println);

        System.out.println("Top 50 Least Common Words After Stemming:");
        top50LeastCommonStemmed.forEach(System.out::println);
